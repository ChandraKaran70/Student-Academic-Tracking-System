                    ...
                    <div className="row ">
                        <div className="col">
                            <form noValidate onSubmit={formHandler}>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="nameId">{isHOD ? "HOD Name":"Faculty Name"}</label>
                                ...
                                {!isLoading && <button type="submit" className="btn btn-info">{isHOD?"Add HOD":"Add Faculty"}</button>}
                            </form>
                        </div>
                    </div>
                </div></>):(history.push('/'))}
