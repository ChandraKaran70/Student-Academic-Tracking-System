...
const StudentTestPerformance = () => {
    ...
    useEffect(() => {
        dispatch(getMarks())
        console.log("marks",store.student.allMarks)
    }, [])
        ...
        <>
            {store.student.isAuthenticated ? <>
                ...
                <div className="container">
                    ...
                    {store.student.allMarks.Mid1 &&
                        <div className="row mt-3">
                            <div className="col-md-8 m-auto">
                                {store.student.allMarks.Mid1.length !== 0 ? <>
                                    <h4>Mid 1</h4>
                                    <table className="table border">
                                        ...
                                        <tbody>
                                            {
                                                store.student.allMarks.Mid1.map((res, index) =>
                                                    <tr key={index}>
                    ...
                    {store.student.allMarks.Mid2 &&
                        <div className="row mt-3">
                            <div className="col-md-8 m-auto">
                                {store.student.allMarks.Mid2.length !== 0 ? <>
                                    <h4>Mid 2</h4>
                                    <table className="table">
                                        ...
                                        <tbody>
                                            {
                                                store.student.allMarks.Mid2.map((res, index) =>
                                                    <tr key={index}>
                                                        <th scope="row">{index + 1}</th>
                                                        <td>{res.subject.subjectCode}</td>
                                                        <td>{res.subject.subjectName}</td>
