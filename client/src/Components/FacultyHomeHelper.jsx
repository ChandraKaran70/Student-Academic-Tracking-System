                    ...
                    <nav className="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    <button type="button" className="btn"><Link to="/faculty/selectStudentsAttendance"><li>MARK ATTENDANCE</li></Link></button>
                                </li>
                                <li className="nav-item">
                                    <button type="button" className="btn"><Link to="/faculty/selectStudentsMarks"><li>UPLOAD MARKS</li></Link></button>
                                </li>
                                <li className="nav-item">
