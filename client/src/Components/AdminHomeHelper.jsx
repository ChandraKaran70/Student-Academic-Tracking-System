            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <button type="button" className="btn"><Link to="/admin/addParent"><li>ADD PARENT</li></Link></button>
                        </li>
                        <li className="nav-item">
                            <button type="button" className="btn"><Link to="/admin/addTimetable"><li>ADD TIMETABLE</li></Link></button>
                        </li>
                        <li className="nav-item">
                            <button type="button" className="btn"><Link to="/admin/addHOD"><li>ADD HOD</li></Link></button>
                        </li>
                        <li className="nav-item">
