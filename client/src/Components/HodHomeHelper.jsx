                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item disabled">
                                    <button type="button" className="btn"><Link to="/hod/updateProfile"><li>UPDATE PROFILE</li></Link></button>
                                </li>
                                {/* <li className="nav-item">
                                    <button type="button" className="btn"><Link to="hod/studentAttendance"><li>STUDENTS ATTENDANCE</li></Link></button>
                                </li> */}
                                <li className="nav-item" >
                                    <button type="button" className="btn"><Link to="/hod/selectSection"><li>STUDENTS ATTENDANCE</li></Link></button>
                                </li>
                                <li className="nav-item">
                                    <button type="button" className="btn"><Link to="/hod/selectTest"><li>STUDENTS PERFORMANCE</li></Link></button>
                                </li>
                                <li className="nav-item">
