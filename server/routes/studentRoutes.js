...
const { checkAttendence, getAllStudents, getStudentByName, studentLogin,
    ...
    previousChats, updateProfile, getAllSubjects, getMarks,subjectAttendance1,viewTimetable1 } = require('../controller/studentController')
...
router.get('/checkTimetable', passport.authenticate('jwt', { session: false }), viewTimetable1)

router.get('/subjectAttendance1/:subjectCode', passport.authenticate('jwt', { session: false }), subjectAttendance1)
